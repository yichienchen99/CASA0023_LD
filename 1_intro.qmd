...
This week's lecture introduces passive and active sensors and the four resolutions of remote sensing data (and many other concepts!). The tutorial describes basic workflow of analyzing EO data using SNAP and QGIS. An example of analyzing color composite using SNAP is included at the end of this section.

### Sensors

**Passive sensors** are like human eyes/cameras that do not emit EM waves itself. Sun energy reflection in EM wave and satellite (e.g. Wk2 sensor summary - WorldView-3) capture that.
...
**Active sensors** emit and receive EM wave / energy like radar and x-ray. Examples include SAR and LiDAR.
...
There is trade-off between resolution and time (and cost). The choice of sensors depends on the purpose of the analysis.
